...
plot(P.MVAC,P.GC, pch=20, pty="s", ylab="GC Probability Score", xlab="MVAC Probability Score", xlim=c(0,1),ylim=c(0,1), main=paste(data, "- COXEN Scores for Combination Treatment"))
...
# The workspace must be cleared before running on a new data set. 
rm(list = ls())
